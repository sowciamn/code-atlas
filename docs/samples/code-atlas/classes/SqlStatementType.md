...
* Declaration: `ENUM`
* Type: `UNKNOWN`
* Source: `code-atlas-core/src/main/java/io/github/codeatlas/core/model/SqlStatementType.java`
...
| --- | --- | --- |
| [MyBatisMapperXmlParser](MyBatisMapperXmlParser.md) | METHOD_RETURN_TYPE | statementType |
