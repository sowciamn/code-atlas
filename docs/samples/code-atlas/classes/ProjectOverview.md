...
* Declaration: `TYPE`
* Type: `UNKNOWN`
* Source: `code-atlas-core/src/main/java/io/github/codeatlas/core/model/ProjectOverview.java`
...
| --- | --- | --- |
| [MarkdownRenderer](MarkdownRenderer.md) | METHOD_PARAMETER | overview |
